...
```{r, eval=FALSE}
bend_labs_data <- dplyr::read_csv("path/to/bend-genetics-lab.csv")
```
...
check_missing_data_in_target <- function() {
  result <- ifelse(any(is.na(all_files()$Target)), FALSE, TRUE)
  
  return(list(result = result, description="Checking for missing data in 'TARGET' column"))
}
...
#   HTML(
#     paste(
#       "<ul><li> Checking for missing data in 'Target' column: ",
#       "<b>",
#       ifelse(any(is.na(all_files()$Target)), emo::ji("x"), emo::ji("check")),
#       "</b></li></ul>"
#     )
#   )
# })
...
#   HTML(
#     paste(
#       "<ul><li> Unique toxigeneic cyanobacteria collected in the 'Target' column: ",
#       "<b>",
#       paste(unique(all_files()$Target, "\n")),
#       "</b>",
#       "</ul></li>"
#     )
#   )
...
#     tags$tr(
#       tags$td(
#         "Unique water quality analytes collected in the 'ANALYTE' column",
#         style = "padding:5px"
#       ),
#       tags$td(unique(all_files()$ANALYTE), style = "padding:5px")
#     )
#   )
# ))
...
Example code:
This chunk selects a column called "Project ID" and save it in a new variable.
```{r, eval=FALSE}
