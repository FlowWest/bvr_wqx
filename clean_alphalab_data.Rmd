...
# check_unique_analytes <- function(analytes_list){
#   
# 
#   return(
...
conditionalPanel(condition="$('html').hasClass('shiny-busy')",
                            tags$div(HTML("<b> Starting WQX upload. Please wait 20 seconds for the upload status from CDX...</b>"),id="loadmessage"))
