...
We will read the excel files using the function `read_excel()` from the readxl package. The script will create a data frame of AlphaLab data by binding each file by row using the function `rbind().` The result is one data frame with all the data from the folder.
