...
check_missing_data_temp <- function() {
  result <- ifelse(any(is.na(all_files()$Temp)), FALSE, TRUE)
  
  return(list(result = result, description="Checking for missing data in 'Temp' column"))
}
...
# check_project_in_lookup <- function(){
#   result <- ifelse(all(all_files()$location_id %in% names(project_id_lookup)), TRUE, FALSE)
#   
#   return(list(result = result, description="Checking 'Location' column all in listed Project Sites"))
# }
